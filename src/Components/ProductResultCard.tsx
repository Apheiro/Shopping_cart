...
export default function ProductResultCard({ img, condition, title, model, sku, price }: Props) {
    ...
    return (
        <div className={` ${isMobile ? 'grid grid-cols-[minmax(20px,160px)_auto] grid-rows-[auto_1fr]' : 'flex'} gap-5 p-3 rounded-lg  bg-dbm  text-base text-neutral-300 w-full max-w-4xl`}>
            ...
            <div className={`${isMobile ? 'justify-evenly' : 'justify-between'} w-full flex flex-col `}>
